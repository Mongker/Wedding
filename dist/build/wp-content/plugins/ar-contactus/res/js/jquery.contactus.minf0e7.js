        ...
        $.each(this.settings.items, function(i){
            ...
            if (this.href == 'callback'){
                ...
                if (this.title == 'Zalo'){
                    ...
                    var $item = $('<a>', {
                        class: 'messanger aaaa ' + (this.class? this.class : ''),
                        id: (this.id? this.id : null),
                        rel: 'nofollow noopener',
                        href: this.href,
            ...
            if (this.title == 'Zalo'){
                var $icon = $('<div class="zalo-chat-widget" data-oaid="3495395388396646101" data-welcome-message="Rất vui khi được hỗ trợ bạn!" data-autopopup="0" data-width="440" data-height="500"></div>');
            }else{
